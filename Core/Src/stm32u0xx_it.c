...
void EXTI0_1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(NH_right_Pin);
...
void EXTI2_3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(NH_down_Pin);
...
void EXTI4_15_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(NH_up_Pin);
  HAL_GPIO_EXTI_IRQHandler(NH_enter_Pin);
  HAL_GPIO_EXTI_IRQHandler(NH_left_Pin);
